...
|------|-----|--------------|
| Primary | `#0B2447` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Primary Hover | `#071A35` | `--color-primary-hover` |
| Accent/CTA | `#0B2447` | `--color-accent` |
| On Accent/CTA | `#FFFFFF` | `--color-on-accent` |
| Gold/Champion | `#FBBF24` | `--color-gold` |
| Background | `#EEF3FA` | `--color-primary-50` |
| Foreground | `#0B2447` | `--color-primary-800` |
| Card | `#FFFFFF` | `--color-card` |
| Muted Foreground | `#475569` | `--color-muted-foreground` |
| Border | `#B7C9E6` | `--color-primary-200` |
| Destructive | `#DC2626` | `--color-danger` |
| On Destructive | `#FFFFFF` | `--color-on-danger` |
| Ring | `#0B2447` | `--color-primary` |

**Color Notes:** Navy + championship gold [Accent adjusted from #FBBF24] — Destructive #DC2626 dipisah dari brand (rose-600 #E11D48 dicoba lalu dibatalkan karena merah kembali bebas setelah primary jadi navy).
